...
<nav class="navbar navbar-default" role="navigation">
	...
	<a class="navbar-brand" href="index.php?Page=1">
	   <img style="margin-top: -12px;" src="images/fullpdf.png" width=100;height=30;>
	</a>
		</div>
		...
		<form action="index.php?Page=1" class="navbar-form navbar-right">
...
<div class="container"> <!--Container-->
	...
	$ViewQuery="SELECT * FROM admin_panel ORDER BY id desc LIMIT $ShowPostFrom,5";
		...
		?>
			...
			<img align="left" class="img-responsive img-rounded"src="Upload/<?php echo $Image;  ?>" >
		<div class="caption">
			<h1 id="heading"> <?php echo htmlentities($Title); ?></h1>
		<br/><p class="description">Category:<?php echo htmlentities($Category); ?> Published on
...
<?php } ?>
	...
	if(isset($Page))
	{
		...
		$RowPagination=mysql_fetch_array($ExecutePagination);
		 ...
		 //for check total pages uncomment the belo
		 // echo $TotalPosts;
...
while($DataRows=mysql_fetch_array($Execute)){
	...
	?>
<div>
<img class="pull-left" style="margin-top: 10px; margin-left: 0px;"  src="Upload/<?php echo htmlentities($Image); ?>" width=60; height=60;>
...
<div id="Footer">
<hr><p>Theme By | |&copy;2018-2020 --- All right reserved.
</p>
